...
function gameLoop() {
    ...
    let amt = 6 * dt; // at 60 FPS would move about 10% distance per update
...
function end() {
    ...
    explosions.forEach(c => gameScene.removeChild(e));
    explosions = [];
...
function createExplosion(x,y, frameWidth, fameHeight){
    let w2 = frameWidth /2;
    let h2 = fameHeight /2;
